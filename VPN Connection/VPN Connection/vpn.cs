...
namespace VPNManager {
    ...
    public class VPN {
        ...
        /// </summary>
        private const string VPNPROCESS = "C:\\WINDOWS\\system32\\rasdial.exe";
        #endregion
        ...
        private bool ConnectToVPN() {
            bool RV = false;
            Console.WriteLine(VPNPROCESS);
            try {
                OnConnecting();
                Console.WriteLine(VPNPROCESS);
                Process.Start(VPNPROCESS, _VPNConnectionName+" jundjkft jundjkft");
                /*string TEXTDATA = "jundjkft";
